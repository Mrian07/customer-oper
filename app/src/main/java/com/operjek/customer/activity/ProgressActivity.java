...
import com.operjek.customer.gmap.directions.Directions;
import com.operjek.customer.gmap.directions.Route;
import com.operjek.customer.item.ItemPesananItem;
...
import com.operjek.customer.json.fcm.DriverResponse;
import com.operjek.customer.json.fcm.FCMMessage;
import com.operjek.customer.models.DriverModel;
import com.operjek.customer.models.LokasiDriverModel;
import com.operjek.customer.models.TransaksiModel;
import com.operjek.customer.models.User;
import com.operjek.customer.utils.NetworkManager;
...
import com.operjek.customer.utils.api.service.BookService;
...
import static com.operjek.customer.json.fcm.FCMType.ORDER;
import static com.operjek.customer.utils.MapsUtils.getBearing;
import static com.operjek.customer.utils.api.service.MessagingService.BROADCAST_ORDER;
            ...
            public void onResponse(Call<DetailTransResponseJson> call, Response<DetailTransResponseJson> responsedata) {
                if (responsedata.isSuccessful()) {
                    ...
                    || fitur.equalsIgnoreCase("12") || fitur.equalsIgnoreCase("13")) {
                        ...
                        itemPesananItem = new ItemPesananItem(ProgressActivity.this, responsedata.body().getItem(), R.layout.item_pesanan);
